...
\begin{frame}{I1 — Jitter and Timing Budget}
  \begin{columns}[T]
    ...
    \begin{itemize}\setlength\itemsep{3pt}
      ...
      \item \textbf{SiPM jitter:} single-photon timing resolution (SPTR) of AFBR-S4N66P024M $\sim\!100\ps$
    ...
    Does not include: SPTR jitter, electronic jitter.\\[4pt]
    \alert{Quoted $\sigma_\text{TOP}=15.2\ps$ is a lower bound.}
    Adding $\sigma_\text{SPTR}\approx100\ps/\sqrt{k\cdot N_\text{active}}$ in quadrature will increase $\sigma_t$.
