...
- Effective attenuation: left 30.70 +/- 0.02 cm; right 30.82 +/- 0.02 cm. These include light extraction through 70 Top windows and are not expected to equal the 160 cm bulk ABSLENGTH.
...
- Top analytic estimate, nearest channel: 58.10-63.13 ps; nearest-three group: 35.44-37.52 ps. This is an analytic estimate, not simulated sigma_t.
