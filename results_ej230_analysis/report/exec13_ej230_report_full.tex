...
% EXEC_14E APPENDED BACKUP START
...
\begin{frame}{Backup: far-End adaptive $t_N$ at $x=-690$ mm}
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]%
{figs/exec14d_adaptive_tN_-690mm.png}
\end{frame}

\begin{frame}{Backup: far-End adaptive $t_N$ at $x=-650$ mm}
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]%
{figs/exec14d_adaptive_tN_-650mm.png}
\end{frame}

\begin{frame}{Backup: far-End adaptive $t_N$ at $x=-400$ mm}
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]%
{figs/exec14d_adaptive_tN_-400mm.png}
\end{frame}

\begin{frame}{Backup: far-End adaptive $t_N$ at $x=+0$ mm}
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]%
{figs/exec14d_adaptive_tN_0mm.png}
\end{frame}

\begin{frame}{Backup: far-End adaptive $t_N$ at $x=+400$ mm}
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]%
{figs/exec14d_adaptive_tN_400mm.png}
\end{frame}

\begin{frame}{Backup: far-End adaptive $t_N$ at $x=+650$ mm}
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]%
{figs/exec14d_adaptive_tN_650mm.png}
\end{frame}

\begin{frame}{Backup: far-End adaptive $t_N$ at $x=+690$ mm}
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]%
{figs/exec14d_adaptive_tN_690mm.png}
\end{frame}

% EXEC_14E APPENDED BACKUP END
