#!/usr/bin/env python3
"""
analyze_basic.py — análisis básico de photon_hits.root generado por ej200_v2
Requiere: uproot, numpy, matplotlib, pandas

Uso:
    python analysis/analyze_basic.py                     # lee photon_hits.root
    python analysis/analyze_basic.py mi_archivo.root
"""
