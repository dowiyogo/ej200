#!/usr/bin/env python3
"""
resolution_vs_x_FPT.py — Resolucion temporal FPT vs posicion longitudinal x
...
Uso:
    ...
    python analysis/resolution_vs_x_FPT.py mi_scan.root
    python analysis/resolution_vs_x_FPT.py scan.root --out tesis_fig4.pdf
"""
