...
echo "[4/4] Generando informe..."
{
    ...
    echo ""
    echo "Relacion Bar->reflector / Bar->SiPM esperada:"
    echo "  Si Bar->reflector >> Bar->SiPM * 100 -> fotones atrapados o absorbidos"
    echo "  Si Bar->World > Bar->SiPM * 10 -> reflector insuficiente o cara abierta"
